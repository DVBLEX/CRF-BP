...
<body ng-controller="passwordForgotChangeController" ng-cloak>
    ...
    <div class="container-fluid crf-center" ng-cloak>
        ...
        <div ng-hide="passwdChangeSuccess">
            <form name="dataForm" autocomplete="off" novalidate>
                ...
                <div class="form-group">
                    <label for="passwordConfirm">Confirm Password</label> <input type="password" class="form-control" name="passwordConfirm" placeholder="Password" title="Password"
                ...
                <div ng-if="passwordForgotStep2ErrorResponse !== ''">
                    <div class="alert alert-danger" role="alert">
                        <span class="glyphicon glyphicon-remove" aria-hidden="true"></span> <span class="sr-only">Error: </span> {{passwordForgotStep2ErrorResponse}}
                    </div>
                </div>
                <div class="form-group">
                    <button type="button" class="btn btn-primary btn-block" ng-disabled="passwordForgotStep2SubmitButtonDisabled || passwdChangeSuccess"
                        ng-click="passwordForgotChange()">Change Password</button>
                </div>
