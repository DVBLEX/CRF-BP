...
public class OperatorRESTController {
    ...
    @RequestMapping(value = "/password/change", method = RequestMethod.POST, consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    public ApiResponseJsonEntity changePassword(HttpServletResponse response, @RequestBody OperatorJson operatorJson) throws CRFException, CRFValidationException, Exception {
        ...
        if (!passwordEncoder.matches(operatorJson.getCurrentPassword(), loggedOperator.getPassword()))
            ...
            loggedOperator.setPassword(passwordEncoder.encode(operatorJson.getPassword()));
    ...
    @RequestMapping(value = "/contact/form/submit", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
    public ApiResponseJsonEntity submitContactForm(HttpServletResponse response, @RequestParam(value = "queryType") String queryType,
        @RequestParam(value = "queryDetails") String queryDetails) throws CRFException, CRFValidationException, Exception {
